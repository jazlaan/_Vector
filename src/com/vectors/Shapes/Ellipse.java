...
public class Ellipse {
     ...
     */
    public Ellipse(Graphics2D g2, int x1, int y1, int x2, int y2 , boolean filled) {
        ...
        userInterface.content.add("ellipse" + " " + (double)Math.min(x1, x2)/screenWidth + " " + (double)Math.min(y1, y2)/screenHeight + " " + (double)width/screenWidth + " " + (double)height/screenHeight + "\n");
    }
